...
const yourUsername = "shuang";
const yourPassword = "123";
const yourAPIKey = "75d83998-7232-4bda-86c0-5479df9c7f9f";
const yourBearerToken = "b8c498f4-44d8-46cc-bc0e-8c573f015959";
...
app.get("/noAuth", async (req, res) => {
  try {
    ...
    res.render("index.ejs", { content: "Data does not exist" });
  }
